        ...
        <div className="App">
          <div className="content_app_container">
            ...
            <TitleBlock
              ...
              header = "Экскурсии"
              subheader = "по Санкт-Петербургу, пригородам"
              img_head = {header}
              description = "Red Star Travel является лицензированным туроператором, предлагающим туры как по Санкт-Петербургу, так и в Москве. Наша команда состоит из преданных своему делу сотрудников c опытом работы в сфере туризма от 20 лет."
              btn
              main={true}
            />
