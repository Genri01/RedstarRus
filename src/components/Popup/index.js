  ...
  render() {
    ...
    return (
      <div style={{display: (show && !close)? 'flex': 'none'}} className="popup_container">
        ...
        <input name="email" placeholder="your@eamil.com" className="popup_input" type="text" value={email} onChange={changeEmail} />
        ...
        <div className="container_btn">
          ...
          <input className="input_submit" type="submit" value="ОТПРАВИТЬ" />
        </div>
        </form>
      </div>
    );
