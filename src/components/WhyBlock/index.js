        ...
        <div className="why_container_card">
          {
            blocks.map((el,id) => (
              <div className="why_card" key={id}>
                <img className="why_card_img" src={id === 1 ? el.img :`https://pixboost.com/api/2/img/https://ru.redstarbaltic.com/${el.img}/optimise?auth=MTQ4OTY2NTYyMw__`}  alt="why_img" width={146} height={146} />
